...
const MANUAL_CHANGELOG = [
  { date: "2026-09-06", type: "update", text: "操作性の改善を行いました。", details: [
    ...
    "一部の教材で、全画面表示ボタンを押しやすくしました。",
    "『すごろく』の「ねむってしまった」マスを1回休みに変更しました。",
    "『すごろく』のマス数の表示を数字と読み仮名でわかりやすくしました。",
    "『すごろく』に新しいマス「ぎゃくてん」を追加しました。",
    "『すごろく』の「たつまきにとばされた」マスは、1人1回までの効果に変更しました。"
  ], verbatim: true },
