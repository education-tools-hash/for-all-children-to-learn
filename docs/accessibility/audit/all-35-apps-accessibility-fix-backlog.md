...
| TIER2-F2(FT-2拡張)+TIER2-F3(Initial Focus、ongaku-app分) | ongaku-app(modal-pin/export/share) | 2〜3日(role="dialog"新規付与含む) | Open。**統合実装を推奨(`FIX-P2-ONGAKU-MODAL`仮称)** |
...
2. **構造Fix(中規模)**: TIER1-F3/TIER2-F2(Focus Trap新規実装、TIER1-F6のSpec Decision確定後が望ましい)→ `FIX-P2-ONGAKU-MODAL`(ongaku-app統合実装)→ TIER2-F5/TIER3-F2(Reflow、方針決定後)
