...
const MANUAL_CHANGELOG = [
  { date: "2026-08-11", type: "update", text: "「すごろく」の不具合を修正しました。", details: [
    "スイッチ操作でスキャンをオフにした直後に、選んだボタンのハイライトが消えずに残ってしまうことがある問題を修正しました。",
  ] },
  { date: "2026-08-11", type: "update", text: "「おんがくあそび」の不具合を修正しました。", details: [
    "スイッチ操作でスキャン中に、アクセシビリティ設定などの共通ボタンを選んで決定すると操作できなくなる問題を修正しました。",
  ] },
