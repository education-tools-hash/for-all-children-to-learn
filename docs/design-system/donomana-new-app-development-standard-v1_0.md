# どのまな 新規アプリ開発標準仕様書 v1.5

- 版: v1.5
- 発行: 2026-08-12（v1.0）／改訂: 2026-08-13（v1.1）／改訂: 2026-08-15（v1.2）／改訂: 2026-08-19（v1.3）／改訂: 2026-08-19（v1.4）／改訂: 2026-08-19（v1.5）
...
| `docs/design-system/donomana-gaze-accessibility-standard-v1_0.md` | v1.0（改訂2） | **確定（Phase M11.3-A/B/CでMulti-Input Pilot 3教材へ実装完了）** | 視線入力（Gaze/Dwell）固有の設定・UI・lifecycle・Multi-Input統合要件。本書13章の詳細補足文書 |
