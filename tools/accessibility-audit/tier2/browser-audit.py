# WCAG-JIS-AUDIT-1-TIER2: Browser Gate (load, console/page error, responsive overflow, A11y panel basic)
# across all 17 Tier2 apps. Read-only.
import json
import sys
...
APPS = ['hiragana-learn','katakana-app','shiritori2','bosai-app','cup_game','ongaku-app','kimochi-board','drawing-app','directions-app','suji-manabou','kyou-no-kiroku','kurabeyou-app','katachi-awase-app','miru-hirogaru-app','mitsukete-touch-app','junban-miyou-app','dotchiga-ii-app']
