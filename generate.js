...
const MANUAL_CHANGELOG = [
  { date: "2026-08-30", type: "update", text: "なぞり書きと学習記録の機能を改善しました。", details: [
    "「ひらがな まなぼう！」「カタカナ まなぼう！」に、使い方ガイドと、なぞり書きの判定のくわしさを選べる機能を追加しました。",
    "「ひらがな まなぼう！」「カタカナ まなぼう！」で、書いた文字をあとから見返せるようになりました。",
    "「どこかな？みーつけた！」「じゅんばんにみよう」「おおきい？ちいさい？くらべよう」「かたちをあわせよう」「どっちがいい？」「おかねのおべんきょう」「そーしゃるスキルトレーニング」で、学習の記録を保存・書き出しできるようになりました。",
    "学習の記録をExcelで開いたときに、日付や時刻が正しく表示されるように改善しました。",
    "いくつかの画面で、ボタンの表記やタップしやすさを改善しました。",
  ] },
