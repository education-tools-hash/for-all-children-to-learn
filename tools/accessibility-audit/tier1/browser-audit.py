# WCAG-JIS-AUDIT-1-TIER1: Browser Gate (load, console/page error, responsive overflow, A11y panel basic)
# across all 12 Tier1 apps. Read-only.
import json
import sys
...
APPS = ['register-app','matching-app','time-timer','mogura-tataki','okane-app','scratch-app','nazorin-print','schedule-app','janken-app','tokei-app','tyushi','gaze-keyboard']
...
with sync_playwright() as p:
    ...
    for app in APPS:
        ...
        # true default-state heading order (Audit plan v1.1 runtime condition)
